...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'manage-services-categories', name: 'manageServicesCategories', component: () => import('src/pages/ManageServicesCategories.vue'), meta: { admin: true } },
      ...
      { path: 'form-service-categories/:id?', name: 'formServiceCategories', component: () => import('pages/FormServiceCategories.vue'), props: true },
